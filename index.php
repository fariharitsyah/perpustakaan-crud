...
<html lang="en">
  <head>
    ...
    <style>
      ...
      body {
        background-image: url("fari.jpeg");
    ...
    <section class="py-5 text-center container">
        <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
                <h1 class="fw-light text-primary">Portal Perpustakaan</h1>
                <p class="lead text-primary text-bold Font-weight: 700">Website ini bisa mempermudah proses audit pinjam meminjam buku</p>
                <p>
